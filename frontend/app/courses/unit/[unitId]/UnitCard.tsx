...
const UnitCard = ({ unitDetails }: Props) => {
  ...
  return (
    <div className='w-5/6 md:w-full rounded-2xl min-h-52 md:min-h-44 p-8 md:p-1 
    border border-gray-400 dark:border-gray-700 
    md:absolute md:top-32 md:z-50 md:backdrop-blur-md 
    bg-gray-200/15 dark:bg-transparent backdrop-blur-sm '>
      ...
      <div className='flex  items-center justify-start gap-6 md:gap-2'>
        ...
        <div>
          ...
          <h2 className='text-gray-900 dark:text-gray-300 text-2xl md:text-xl font-semibold mb-4'>
            {unitDetails.name}
          </h2>

          {/* <p className=' mt-4 text-gray-600 dark:text-gray-400'>{unitDetails.desciption}</p> */}
