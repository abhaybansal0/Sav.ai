...
import { Code, BookOpen, Clock, Star, ChevronRight, Play } from 'lucide-react';
import { CoursesType } from '@/lib/types';
import Link from 'next/link';

const CourseCard = ({
    _id, name, icon, description, rating = 4, students = 0, duration = '3 Weeks', unitCount, difficulty, progress, isStarted, gradientColors = 'from-blue-500 via-purple-500 to-pink-500'
}: CoursesType) => {
